...
<?php
	...
	{	
		    ...
		    else
		    {
				...
				if($stmt = mysqli_prepare($conn,$query))
				{
					...
					if(mysqli_stmt_execute($stmt))
					{
						...
						// echo "<h2>You have login Successfully</h2>"."<br>";
						echo "<a href=index.php><button>Click here to see your Post</button></a>";

					}else{echo "Unable to make post ".mysqli_error($conn);}	
		...
		else
		{
			...
			echo "<a href=login.php><button>Click Here to login</button></a>";
		}
	}		
