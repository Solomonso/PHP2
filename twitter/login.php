...
<body>
	<div class="header-img">
		...
		<a href='index.php'><button class='style-login-right'>Home</button></a>
	</div>
...
<?php
	...
	if(!$conn)
	{
		echo "Could not connect to the server".mysqli_error($conn);
	}
	  ...
	  {	
		  	...
		  	{	
		 		...
		 		{
		 			echo "<h1></h1>"."<br>";
		 		}else{echo "Error could not execute".mysqli_error($conn);}
		 		...
		 		{	
				 	...
				 	{	
				 		if($verify=password_verify($password,$hash_pass))
				 		{
				 			...
				 			}else{echo "<h1>Not registered yet</h1>";}		
			 	...
			 	else
			 	{
			 		...
			 		echo"<a href=sign_up.php><button class=sign-up>Sign Up</button></a>";
			 	}
		...
		<div class="form-style-login">
			<form action="login.php" method="POST">
				<h2 class="head-text-color">Login</h2>
					<p class="form-field"> <input type="text" name="user_name" id="name-field" placeholder="UserName" class="style" required></p>
					<p class="form-field"><input type="password" name="password"  id="pass-field-login" placeholder="Password" class="style" required></p>
